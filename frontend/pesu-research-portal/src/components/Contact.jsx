  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-2 overflow-y-auto" style={{
        ...
        <div className='text-bold font-serif  text-center  text-white p-44'>
        ...
        <div className="flex justify-center bg-blue-950 font-serif">
          <div className='bg-white h-90 w-80 justify-evenly text-center p-8 m-5 '>
            <div className='p-0'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width={1.5} stroke="currentColor" className="w-10 h-10 ">
              ...
              PES University, 100 Feet Ring Road BSK III Stage, Bangalore - 560085
            </p>
            <br />
            ...
            <p className='flex gap-4' >
                ...
                <a href="mailto:admissions@pes.edu" className='text-blue-600'>admissions@pes.edu</a>
            </p>
            ...
            <a href="https://goo.gl/maps/eBTxHeqL78eRxwve8" className='text-blue-600' target="_blank" rel="noopener">View On Google Map</a>
            </p>
          ...
          <div className='bg-white h-80 w-80 justify-evenly text-center p-10 m-5'>
            ...
            <p className='flex items-center justify-center'>
              ...
              <span className='pl-3'>Dr. J. Manikandan</span>
            </p>
            <p className='flex items-center justify-center'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
              </svg>
              <span className='pl-3'>manikandanj@pes.edu</span>
            </p>
          </div>
          ...
          <div className='bg-white h-80 w-80 justify-evenly text-center p-10 m-5'>
            ...
            <p className='flex items-center justify-center'>
              ...
              <span className='pl-3'>dean.research@pes.edu</span>
            </p>
          </div>
          ...
          <div className='bg-white h-80 w-80 justify-evenly text-center p-10 m-5'>
            ...
            <p className='flex gap-4'>
              ...
              <a href="mailto:dean.research@pes.edu" className='text-blue-600'>dean.research@pes.edu</a>
