...
return (
    ...
    <div className="grid grid-cols-1 gap-2 overflow-y-auto" style={{
        ...
        <div className='bg-white h-90 w-80 justify-evenly text-center p-8 m-5 rounded-lg '>
            ...
            <p className='flex gap-4 text-center font-medium'>
        ...
        <div className='bg-white h-90 w-80 justify-evenly text-center p-8 m-5 rounded-lg '>
            ...
            <h3 className='text-sky-800 font-semibold text-xl p-5'>
                PES UNIVERSITY
                <br />
                <span>Electronic City Campus</span>   
            </h3>
            ...
            <a href="https://maps.app.goo.gl/FGN7p2jWEz5uHmAz6" className='text-blue-600' target="_blank" rel="noopener">View On Google Map</a>
            </p>
        ...
        <div className='bg-white h-90 w-80 justify-evenly text-center p-8 m-5 rounded-lg  '>
            ...
            <h3 className='text-sky-800 font-semibold text-xl p-5'>
                PES UNIVERSITY
                <br />
                <span>Hanumantha Nagar Campus</span>   
            </h3>
            ...
            <a href="https://maps.app.goo.gl/j6XcmhLkAdRxvT7u5" className='text-blue-600' target="_blank" rel="noopener">View On Google Map</a>
            </p>
