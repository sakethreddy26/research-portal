...
const HomePage = () => {
    ...
    const fetchPublicationsByYear = async () => {
      try {
        ...
        const publicationsByYear = publicationsData.reduce((acc, pub) => {
          const year = pub.Year || "Unknown"; // Default to 'Unknown' if no year
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">WELCOME TO PESU RESEARCH PORTAL</h1>
      ...
      <div className="flex justify-around mb-8">
        <div className="bg-gray-100 p-4 rounded-md shadow-md">
          <h3 className="text-xl">Total Professors</h3>
          <p className="text-2xl">{professors.length}</p>
        </div>
        <div className="bg-gray-100 p-4 rounded-md shadow-md">
