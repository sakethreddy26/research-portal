...
{/* ******************process*********** */}
        <div className="hidden col-span-3 flex-auto mr-10 ml-7 p-5 bg-white bg-opacity-90 font-serif" id="ppa" data-answer-content1>
          ...
          <div className="space-y-5 text-lg">
            ...
            <div>
              <p className="font-bold cursor-pointer" data-question="q3" data-answer="a3">
            ...
            <div>
              <p className="font-bold cursor-pointer" data-question="q4" data-answer="a4">
            ...
            <div>
              <p className="font-bold cursor-pointer" data-question="q5" data-answer="a5">
            ...
            <div>
              <p className="font-bold cursor-pointer" data-question="q6" data-answer="a6">
                6. What time lines are to be adhered to while prosecuting a patent application in India?
              </p>
              <p className="pl-10 hidden" id="a6">
                Following are some of the important time lines during the prosecution of a patent application.
                <img src="img/patent-timeline.png" alt="Patent Timeline" />
              </p>
            </div>
            <div>
              <p className="font-bold cursor-pointer" data-question="q7" data-answer="a7">
                7. Where to File a Patent Application?
              </p>
              <p className="pl-10 hidden" id="a7">
                1. Physical filing : You can apply for any one of the Indian patent offices, which are located in Chennai, Delhi, Mumbai, or Kolkata, at the counter of the jurisdictional patent office. The Patent application can be submitted at the appropriate patent office and is determined based on the applicant's region/location. For the applicant, who is non-resident or has no residence or has no place of business in India, the address for service in India or place of business of his patent agent determines the appropriate patent office where applications for a patent can be filed. Suppose, as an applicant, you do not have a place of residence, domicile, or place of business in India. Accordingly, the place for filing your application will depend on the address you have furnished for the service. For example, patent applications are submitted at the Chennai Patent Office when the address for services is Intepat, Bangalore. It is important to note that, ordinarily, once the appropriate office has been decided, it cannot be changed.
                <br />
                <strong>2. E-Filling :</strong> This can be done using the e-filing portal of the patent office.
                <br />
                Physical Documents for applying at Indian Patent Office:
                <br />
                1. Form-1: Application for grant of a patent [in duplicate]
                ...
                <span className="pl-10">
                  ...
                  - Digital signature;
                  <br />
                  - Sufficient balance in the payment gateway.
                </span>
              </p>
            </div>
            <div>
        ...
        <div className="hidden col-span-3 mr-10 ml-7 p-5 font-serif  rounded-lg leading-4 " id="ppb" data-answer-content1>
          ...
          <p className="text-2xl flex">Upload any recently published Patent Details</p>
            <div className=" flex flex-wrap">
              ...
              <div className="mt-5 ml-20 block leading-10">
                <p className="text-lg">Upload the Certificate</p>
                <label htmlForfor="file " className="text-lg">Select a file:
          ...
          <div className="bg-transparent mt-10 flex-wrap leading-7" id="ppb">
              ...
              <div className="opacity-90 bg-white rounded p-10 pt-4">
                <div className="flex">
                  <p className="text-xl text-black pl-5">Title : A SHOPPING TROLLEY WITH AUTOMATIC BILLING SYSTEM</p>
                  <p className="text-xl text-black pl-10 pr-10">Patent Number : 541176</p>
                  <p className="text-lg text-black pl-10 pr-10">Year of Award : 07/06/2024</p>
                </div>
                <div className="flex">
                  <p className="text-lg text-black pl-5  pr-72">Deepti C</p>
                  <a href="https://drive.google.com/file/d/1b7W9i5Fl0iwnI_-OHWrt_ozehG0Vw367/view?usp=sharing" className="pl-72 pr-10 text-lg text-blue-600 underline ">
              ...
              <div className="bg-transparent mt-10 flex-wrap leading-7" id="ppb">
                ...
                <div className="opacity-90 bg-white rounded p-10 pt-4">
                  <div className="flex">
                    ...
                    <p className="text-xl text-black pl-10 pr-10">Patent Number : 409651-001</p>
                    <p className="text-lg text-black pl-10 pr-10">Year of Award : 02/05/2024</p>
                  </div>
                  <div className="flex">
                    <p className="text-lg text-black pl-5  pr-72">Dr.Suja C M</p>
                    <a href="https://drive.google.com/file/d/1MaY6AQ6vh7p8pmznTol1oPGwus2gtu8d/view?usp=sharing" className="pl-72 pr-10 text-lg text-blue-600 underline ">
                    Link to Patent Published Certificate</a>
                ...
                <div className="bg-transparent mt-10 flex-wrap leading-7" id="ppb">
                    ...
                    <div className="opacity-90 bg-white rounded p-10 pt-4">
                          <div className="flex">
                            ...
                            <p className="text-xl text-black pl-10 pr-10">Patent Number : 415054-001</p>
                            <p className="text-lg text-black pl-10 pr-10">Year of Award : 13/06/2024</p>
                          </div>
                          <div className="flex">
                            <p className="text-lg text-black pl-5  pr-72">Prof.Surbhi Choudhary</p>
                            <a href="https://drive.google.com/file/d/1Qp39yg64O7r45sng_Vl03thijVBdKh0-/view" className="pl-72 pr-10 text-lg text-blue-600 underline ">
                            Link to Patent Published Certificate</a>
